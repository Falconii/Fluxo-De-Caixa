    ...
    class daoUsuario
    {
        ...
        public Usuario Insert(Usuario obj)
        {
            ...
            String StringInsert = $" INSERT INTO USUARIOS " +
                                "(RAZAO, CNPJ_CPF, CADASTR, ENDERECO, BAIRRO, CIDADE, UF, CEP, TEL1, TEL2, EMAIL, SENHA) " +
                                " VALUES(" +
                                $" '{obj.Razao}','{obj.Cnpj_Cpf}','{obj.Cadastr}','{obj.Endereco}', '{obj.Bairro}' , '{obj.Cidade}','{obj.Uf}','{obj.Cep}','{obj.Tel1}','{obj.Tel2}','{obj.Email}','{obj.Senha}')";
            try
            {
